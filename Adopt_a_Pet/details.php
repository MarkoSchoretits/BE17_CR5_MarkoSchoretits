...
if (mysqli_num_rows($result)  > 0) {
    while ($row = mysqli_fetch_array($result, MYSQLI_ASSOC)) {
        ...
        $tbody .= "<tr>
            ...
            <td>" . $row['status'] . "</td>
            <td>
                <a href='adopt.php?id=" . $row['id'] . "'><button class='btn btn-primary btn-sm' type='button'>Take Me Home</button></a>
            </td>
            </tr>";
    };
} else {
...
<!-- 
 ...
 -->
            <p class='h2'>This is <?php echo $selected_name ?></p>
            <a href='home.php?'><button class='btn btn-primary btn-sm' type='button'>Show all animals!</button></a><br><br>
