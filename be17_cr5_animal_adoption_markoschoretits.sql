...
--
-- Host: 127.0.0.1
-- Erstellungszeit: 19. Nov 2022 um 14:20
...
INSERT INTO `adoptions` (`id`, `date`, `fk_user_id`, `fk_animal_id`) VALUES
(1, '0000-00-00', 6, 1),
(2, '2022-11-19', 6, 2),
(3, '2022-11-19', 6, 6),
(4, '2022-11-19', 6, 5),
...
(1, 'Achmed', 1, 'only one hump', 'BIG', 6, 'none', 'Camel/Dromedar', 'Animal-960x640.png', 'available'),
